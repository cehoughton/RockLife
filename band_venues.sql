...
--
-- Name: venues_played; Type: TABLE; Schema: public; Owner: Guest; Tablespace: 
--

CREATE TABLE venues_played (
    id integer NOT NULL,
    band_id integer,
    venue_id integer
);
...
ALTER TABLE venues_played OWNER TO "Guest";

--
-- Name: venues_played_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--

CREATE SEQUENCE venues_played_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE venues_played_id_seq OWNER TO "Guest";

--
-- Name: venues_played_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--

ALTER SEQUENCE venues_played_id_seq OWNED BY venues_played.id;
...
ALTER TABLE ONLY venues_played ALTER COLUMN id SET DEFAULT nextval('venues_played_id_seq'::regclass);
...
--
-- Data for Name: venues_played; Type: TABLE DATA; Schema: public; Owner: Guest
--

COPY venues_played (id, band_id, venue_id) FROM stdin;
\.


--
-- Name: venues_played_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--

SELECT pg_catalog.setval('venues_played_id_seq', 1, false);
...
--
-- Name: venues_played_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest; Tablespace: 
--

ALTER TABLE ONLY venues_played
    ADD CONSTRAINT venues_played_pkey PRIMARY KEY (id);
